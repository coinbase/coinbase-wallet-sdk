...
interface ClientAnalyticsIdentityData {
  ...
  languageCode?: string;
  locale?: string;
  [key: string]: unknown; // Allows for other custom user properties
}
...
interface ClientAnalyticsEventData {
  ...
  loggingId?: string;
  [key: string]: unknown; // Allows for other custom event properties
}
...
interface ClientAnalyticsStatic {
  ...
  markNTBT(): void;
  identifyFlow(flowData: Record<string, unknown>): void;
