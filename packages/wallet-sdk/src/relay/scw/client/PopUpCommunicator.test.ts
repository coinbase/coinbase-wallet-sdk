...
describe('PopUpCommunicator', () => {
  it.skip('should connect and listen for ready event, and send request', async () => {
    // const communicator = PopUpCommunicator.shared;
    ...
    // const sendPromise = communicator.request({ message: 'test' });
