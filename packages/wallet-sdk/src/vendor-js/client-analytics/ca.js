  ...
  (() => {
    var e = {
        792: (e) => {
          var t = {
            utf8: {
              stringToBytes: (e) => t.bin.stringToBytes(unescape(encodeURIComponent(e))),
              bytesToString: (e) => decodeURIComponent(escape(t.bin.bytesToString(e))),
            },
            bin: {
              stringToBytes: (e) => {
        ...
        2: (e, t, n) => {
          ...
          var r,
            ...
            u = o.performance,
            l = () => c.deviceMemory,
            d = () => c.hardwareConcurrency,
            p = 'mark.',
            m = () => u && !!u.getEntriesByType && !!u.now && !!u.mark,
            f = '4g',
            v = !1,
            g = {},
            b = { value: 0 },
            ...
            S = (e, t) => {
              try {
                var n = new PerformanceObserver((e) => {
                  t(e.getEntries());
                });
            ...
            O = (e) => parseFloat(e.toFixed(4)),
            j = (e) => ('number' != typeof e ? null : O(e / Math.pow(1024, 2))),
            N = (e, t, n, r, i) => {
              var s,
                u = () => {
                  a.analyticsTracker &&
          ...
          var P,
            ...
            U = (e, t) =>
              L[e] ? (t <= L[e][0] ? 'good' : t <= L[e][1] ? 'needsImprovement' : 'poor') : null,
            R = (e, t, n) => {
            ...
            te = -1,
            ne = () => ('hidden' !== document.visibilityState || document.prerendering ? 1 / 0 : 0),
            re = (e) => {
            ...
            me = (e) => {
              ['mousedown', 'keydown', 'touchstart', 'pointerdown'].forEach((t) => e(t, pe, ce));
            },
            fe = 0,
            ve = 1 / 0,
            ge = 0,
            ...
            he = () => (D ? fe : performance.interactionCount || 0),
            we = 0,
            ye = () => he() - we,
            Te = [],
            ke = {},
            _e = (e) => {
              ...
              if (n || Te.length < 10 || e.duration > t.latency) {
                ...
                Te.sort((e, t) => t.latency - e.latency),
                  Te.splice(10).forEach((e) => {
                    delete ke[e.id];
                  });
              }
            },
                          ...
                          s = (e) => {
                            i > -1 &&
                              ((e) => {
                                !((e) => {
                                  if (e.entries.length) {
                                    var t = e.entries.reduce((e, t) =>
                                      e && e.value > t.value ? e : t
                                    );
                                    if (t && t.sources && t.sources.length) {
                                      var n =
                                        (r = t.sources).find(
                                          (e) => e.node && 1 === e.node.nodeType
                                        ) || r[0];
                                      if (n)
            ...
            De = (e, t, n) => {
              ...
              if (u.getEntriesByName(p + n).length > 0 && a.steps) {
                ...
                if (i) {
                  ...
                  if (d <= s) {
                    var m = ((e, t) =>
                      e <= t[0] ? 'good' : e <= t[1] ? 'needsImprovement' : 'poor')(d, c);
                    d >= 0 &&
                ...
                if (
                  ...
                  R('navigationTiming', t),
                    ...
                    a.steps &&
                      ...
                      (Pe.active = {}),
                      (Pe.navigationSteps = {}),
                      Object.entries(a.steps).forEach((e) => {
                        var t,
                          n,
                          r = e[0],
                          i = e[1].marks,
        ...
        426: (e, t) => {
          ...
          var u = { current: null };
          (t.useCallback = (e, t) => u.current.useCallback(e, t)),
            (t.useEffect = (e, t) => u.current.useEffect(e, t)),
            (t.useRef = (e) => u.current.useRef(e));
        },
        784: (e, t, n) => {
          'use strict';
          e.exports = n(426);
        ...
        353: function (e, t, n) {
          ...
          !((i, a) => {
            ...
            var o = 'function',
              ...
              Q = (e, t) => typeof e === u && -1 !== W(t).indexOf(W(e)),
              W = (e) => e.toLowerCase(),
              H = (e, t) => {
                if (typeof e === u)
            ...
            (Z.VERSION = '1.0.35'),
              ...
              typeof t !== s
                ...
                : n.amdO
                  ? (r = (() => Z).call(t, n, t, e)) === a || (e.exports = r)
    ...
    return (
      (() => {
        ...
        const t = 0,
          ...
          c = 5,
          u = 6;
        let l = ((e) => ((e.low = 'low'), (e.high = 'high'), e))({}),
          d = ((e) => (
            (e.count = 'count'),
            (e.rate = 'rate'),
            (e.gauge = 'gauge'),
          ...
          g = ((e) => ((e.web = 'Web'), (e.ios = 'iOS'), (e.android = 'Android'), e))({}),
          b = ((e) => (
            (e[(e.notLoggedIn = 0)] = 'notLoggedIn'), (e[(e.loggedIn = 1)] = 'loggedIn'), e
          ))({}),
          h = ((e) => (
            (e.ac = 'ac'),
            (e.af = 'af'),
          ...
          w = ((e) => ((e.pv = 'pv'), e))({}),
          y = ((e) => (
            (e.xs = 'xs'), (e.s = 's'), (e.m = 'm'), (e.l = 'l'), (e.xl = 'xl'), (e.xxl = 'xxl'), e
          ))({});
