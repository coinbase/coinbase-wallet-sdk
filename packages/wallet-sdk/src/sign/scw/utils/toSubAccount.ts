...
export async function toSubAccount({
  address,
  owner,
  client,
  factory,
  ...
  type SubAccountRPCSchema = [
    ...PublicRpcSchema,
    ...WalletRpcSchema,
    PrepareCallsSchema,
    SendPreparedCallsSchema,
  ];

  // @ts-ignore
  const accountClient: PublicClient<Transport, Chain, undefined, SubAccountRPCSchema> = {
    ...client,
