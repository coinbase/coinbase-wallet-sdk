...
describe('errors', () => {
  ...
  test('standardErrorMessage', () => {
    ...
    expect(standardErrorMessage(standardErrorCodes.provider.userRejectedRequest)).toEqual(
  ...
  test('unsupportedChain error', () => {
    ...
    expect(errorWithChainID.code).toEqual(standardErrorCodes.provider.unsupportedChain);
    expect(errorWithChainID.message).toEqual(expect.stringContaining('Unrecognized chain ID 1234'));
  });
});
